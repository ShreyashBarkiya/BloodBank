                    ...
                    <tr>
                        <td>
                            ...
                            <table cellpadding="0" cellspacing="0" width="800px" height="100px" style="margin:auto; border:0px" class="tableborder">
                                <tr>
                                    <td align="center"><img src="Images/results.png" height="80px" style="padding-top:20px" /></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                </tr>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="700px" height="150px" style="margin:auto; border:none;" class="tableborder">
                                                ...
                                                <tr>
                                                    <td width="100px" style="vertical-align:middle;texy-align:right;">

                                                        <a href="doner_pic<?php echo $data[8] ?>" data-lightbox="image-1"> <img src="doner_pic/<?php echo $data[8] ?>" height="100px" width="100px" style="margin:auto; padding-left:70px; padding-right:50px; float:left" /></a>
                                                    </td>
                                                    ...
                                                    <td width="500px" height="50px" style="vertical-align:top">
                                                        ...
                                                        <table cellpadding="0" width="500px" height="150px" style="border:none">
                                                            ...
                                                            <tr>
                                                                <td style="width:24px"><span class="title">Mobile No:</span></td>
