...
<body>
    ...
    <div class="nav_bg">
        ...
        <div>
            <div style="height:500px; width:100%; margin:auto; margin-top:10px; margin-bottom:10px; background-color:#fff; border:2px solid red; box-shadow:4px 1px 20px black;">
                    ...
                    <div class="col span_2_of_3">
                        <div class="contact-form" style="padding-left:100px;">
                            ...
                            <table cellspacing="0" cellpadding="0" width="500px" height="300px">
                                ...
                                <tr>
                                    <td class="lefttd" style="vertical-align:middle">Subject</td>
