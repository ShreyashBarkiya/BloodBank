		...
		<div style="height:530px; width:500px; margin:auto; margin-top:10px; margin-bottom:10px; background-color:#f8f1e4; border:2px solid red; box-shadow:4px 1px 20px black;">
			<form method="post" enctype="multipart/form-data">
				<table cellpadding="0" cellspacing="0" width="500px" height="480px" style="margin:auto">
					...
					<tr>
						<td class="lefttd" align="center"> Name:</td>
					...
					<tr>
						<td class="lefttd" align="center">Gender</td>
					...
					<tr>
						<td class="lefttd" align="center">Age</td>
					...
					<tr>
						<td class="lefttd" align="center">Mobile No</td>
						<td><input type="number" name="t3" required="required" pattern="[0-9]{10,12}" title="please enter only numbers between 10 to 12 for mobile no." /></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					</tr>
					...
					<tr>
						<td class="lefttd" align="center">E-Mail</td>
					...
					<tr>
						<td class="lefttd" align="center">Till Required Date</td>
						<td>
							<select name="month">
					...
					<tr>
						<td class="lefttd" align="center">Detail</td>
